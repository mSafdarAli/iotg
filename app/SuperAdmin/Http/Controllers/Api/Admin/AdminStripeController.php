...
class AdminStripeController extends ApiBaseController
{
    ...
    public function stripePayment(StripePaymentRequest $request)
    {
        ...
        if ($subcriptionCancel) {
            ...
            if ($plan->max_warehouse < $warehouseCount) {
                throw new ApiException('You can not downgrade plan because you have added ' . $warehouseCount . ' warehouse while your new plan allow max warehouse ' . $plan->max_warehouse);
            }
