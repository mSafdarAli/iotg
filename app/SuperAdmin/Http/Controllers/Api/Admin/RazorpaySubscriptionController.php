...
class RazorpaySubscriptionController extends ApiBaseController
{
    ...
    public function razorpayPayment()
    {
        ...
        if ($expectedSignature === $razorpaySignature) {
            ...
            if ($plan->max_products < $warehouseCount) {
                throw new ApiException('You can not downgrade plan because you have added ' . $warehouseCount . ' warehouse while your new plan allow max products ' . $plan->max_warehouse);
            }
