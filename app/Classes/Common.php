...
class Common
{
    ...
    public static function checkSubscriptionModuleVisibility($itemType)
    {
        ...
        if (app_type() == 'saas') {
            ...
            if ($itemType == 'warehouse') {
                ...
                $company = company();
                $visible = $company && $company->subscriptionPlan && $warehouseCounts <= $company->subscriptionPlan->max_warehouse  ? true : false;
            }
        }
    ...
    public static function allVisibleSubscriptionModules()
    {
        ...
        if (self::checkSubscriptionModuleVisibility('warehouse')) {
            $visibleSubscriptionModules[] = 'warehouse';
        }
