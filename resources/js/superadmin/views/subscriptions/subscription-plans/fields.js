...
const fields = () => {
    const url = "superadmin/subscription-plans?fields=id,xid,name,description,monthly_price,annual_price,max_products,max_warehouse,modules,default,features,is_popular,stripe_monthly_plan_id,stripe_annual_plan_id,paystack_monthly_plan_id,paystack_annual_plan_id,razorpay_monthly_plan_id,razorpay_annual_plan_id,notify_before,duration";
    ...
    const columns = [
        ...
        {
            title: t("subscription_plans.max_warehouse"),
            dataIndex: "max_warehouse",
        },
        {
