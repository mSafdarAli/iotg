    ...
    >
        <a-form layout="vertical">
            <a-row :gutter="16">
                ...
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                        <a-form-item
                            :label="$t('subscription_plans.max_warehouse')"
                            name="max_warehouse"
                            :help="rules.max_warehouse ? rules.max_warehouse.message : null"
                            :validateStatus="rules.max_warehouse ? 'error' : null"
                            class="required"
                        >
                            <a-input-number
                                v-model:value="formData.max_warehouse"
                                :placeholder="
                                    $t('common.placeholder_default_text', [
                                        $t('subscription_plans.max_warehouse'),
                                    ])
                                "
                                :style="{ width: '100%' }"
                            />
