...
class CreateCompanyIdColumnsInAllTables extends Migration
{
    ...
    public function up()
    {
        Schema::create('subscription_plans', function (Blueprint $table) {
            ...
            $table->integer('max_warehouse')->unsigned()->default(0);
        ...
        if ($appEnv == 'saas') {
            ...
            $defaultPlan->max_products            = 5000;
            $defaultPlan->max_warehouse            = 1;
            ...
            $trailPlan->max_products           = env('APP_ENV') == 'production' ? 5000 : 5;
            $trailPlan->max_warehouse           = 1;
